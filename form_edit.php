			...
			<div class="col-md-6">
				...
				<div class="card" style="width: 100%;">
					<div class="card-body">
						...
						include "config.php";
						$id = $_GET['id'];
						$query = mysql_query("SELECT * FROM restoran WHERE id = '$id'") or die(mysql_error());

						$data = mysql_fetch_array($query);
						?>	

						<form action="proses_edit.php" method="post">
							<a href="index.php" class="btn btn-secondary"> < Lihat Data Pesanan</a>
						...
						<!-- 	<div class="form-group">
							...
							<div class="form-group">
								...
								<select class="form-control" name="makanan" value="<?php echo $data['makanan'] ?>">
							...
							<div class="form-group">
								...
								<select class="form-control" name="harga"  value="<?php echo $data['harga'] ?>">
									<option>Harga</option>
